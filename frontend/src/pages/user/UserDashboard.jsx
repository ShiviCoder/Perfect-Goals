 ...
 useEffect(() => {
  ...
  const styles = {
    ...
    sidebar: {
      ...
      width: typeof window !== 'undefined' && window.innerWidth <= 768 ? "100%" : "220px",
      height: typeof window !== 'undefined' && window.innerWidth <= 768 ? "auto" : "100vh",
      minHeight: typeof window !== 'undefined' && window.innerWidth <= 768 ? "auto" : "100vh",
      maxHeight: typeof window !== 'undefined' && window.innerWidth <= 768 ? "80vh" : "100vh",
      display: "flex",
      flexDirection: "column",
      color: "#dde8fc",
      position: "fixed",
      top: typeof window !== 'undefined' && window.innerWidth <= 768 ? (isSidebarOpen ? "56px" : "-100vh") : 0,
      left: typeof window !== 'undefined' && window.innerWidth <= 768 ? 0 : (isSidebarOpen ? 0 : "-260px"),
      fontWeight: 500,
      boxShadow: typeof window !== 'undefined' && window.innerWidth <= 768 ? "0 8px 16px rgb(0 0 0 / 0.2)" : "3px 0 8px rgb(0 0 0 / 0.1)",
      zIndex: 1000,
      userSelect: "none",
      transition: typeof window !== 'undefined' && window.innerWidth <= 768 ? "top 0.3s ease" : "left 0.3s ease",
      overflowY: typeof window !== 'undefined' && window.innerWidth <= 768 ? "auto" : "visible",
      borderRadius: typeof window !== 'undefined' && window.innerWidth <= 768 ? "0 0 12px 12px" : "0",
    },
    logo: {
      display: "flex",
      alignItems: "center",
    ...
    main: {
      marginLeft: typeof window !== 'undefined' && window.innerWidth <= 768 ? "0" : (isSidebarOpen ? "220px" : "0"),
      width: typeof window !== 'undefined' && window.innerWidth <= 768 ? "100%" : (isSidebarOpen ? "calc(100% - 220px)" : "100%"),
      display: "flex",
      flexDirection: "column",
      minHeight: "100vh",
